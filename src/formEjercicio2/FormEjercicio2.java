...
public class FormEjercicio2 extends JFrame {
    ...
    public FormEjercicio2() {
        ...
        panelNotas.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 192)), "Notas del estudiante",
        ...
        panelPromedio_y_Condicion.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 192)),
                "Notas del estudiante", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        EventoCalcularPromedio eventoCalcular = new EventoCalcularPromedio(txtNota1, txtNota2, txtNota3, txtPromedio,
                txtCondicion, cbxAprobado_Desaprobado);
        btnCalcular.addActionListener(eventoCalcular);

        EventoNuevo eventoNuevo = new EventoNuevo(txtNota1, txtNota2, txtNota3, txtPromedio, txtCondicion,
                cbxAprobado_Desaprobado);
...
class EventoCalcularPromedio implements ActionListener {
    ...
    public EventoCalcularPromedio(JTextField nota1, JTextField nota2, JTextField nota3, JTextField promedio,
            JTextField condicion, JComboBox<String> cbxCondicion) {
        this.txtNota1 = nota1;
        this.txtNota2 = nota2;
        this.txtNota3 = nota3;
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        // if (txtNota1.getText().isEmpty()) {txtNota1.setBackground(Color.RED);
        // calcularPromedio = false;}
        // if (txtNota2.getText().isEmpty()) {txtNota2.setBackground(Color.RED);
        // calcularPromedio = false;}
        // if (txtNota3.getText().isEmpty()) {txtNota3.setBackground(Color.RED);
        // calcularPromedio = false;}
    ...
    private void establecerPromedioYCondicion() {
        ...
        if (cbxCondicion.getSelectedItem().equals("Desaprobado") || libre)
...
class soloNumeros2 extends KeyAdapter {
    ...
    public void keyTyped(KeyEvent e) {
        ...
        if ((key < '0' || key > '9') && key != '.')
            e.consume();
        if (key == '.' && texto.getText().contains("."))
            e.consume();
        if (texto.getText().trim().length() == 5)
            e.consume();
    }
}
...
class EventoNuevo implements ActionListener {
    ...
    public EventoNuevo(JTextField nota1, JTextField nota2, JTextField nota3, JTextField promedio, JTextField condicion,
            JComboBox<String> cbxCondicion) {
        this.txtNota1 = nota1;
        this.txtNota2 = nota2;
        this.txtNota3 = nota3;
        this.txtPromedio = promedio;
