...
public class FormEjercicio1 extends JFrame {
    ...
    public FormEjercicio1() {
        ...
        lblNotificacion.setBounds(15, 215, 409, 20);
        contentPanel.add(lblNotificacion);
        ...
        EventoBoton evento = new EventoBoton(txtNombre, txtApellido, txtTelefono, txtFecha, lblNotificacion,
                lblFormato);
...
class EventoBoton implements ActionListener {
    ...
    public EventoBoton(JTextField nombre, JTextField apellido, JTextField telefono, JTextField fecha, JLabel noti,
            JLabel form) {
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if (boolCampos == true) {
            String datos = txt + txtNombre.getText() + " " + txtApellido.getText() + " " + txtTelefono.getText() + " "
                    + txtFecha.getText();
...
class soloNumeros extends KeyAdapter {
    ...
    public void keyTyped(KeyEvent e) {
        ...
        if (texto.getText().trim().length() == 10)
            e.consume();
    }
